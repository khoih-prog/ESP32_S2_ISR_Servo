...
#ifndef ESP32_S2_FastTimerInterrupt_h
#define ESP32_S2_FastTimerInterrupt_h
  ...
  public:
    ...
    bool setFrequency(float frequency, s2_timer_callback callback)
    {
      ...
      {      
        ...
        ISR_SERVO_LOGERROR3(F("ESP32_S2_FastTimerInterrupt: _timerNo ="), _timerNo, F(", _fre ="), TIMER_BASE_CLK / TIMER_DIVIDER);
